...
self.offScreen = true
  ...
  self.targetId = nil
  self.queryRange = 100
  shoulderOffset = config.getParameter("shoulderOffset", {0, 0})
...
function follow(pos, dis)
    local toBoss2 = world.magnitude(pos, self.targetPos) - dis
    local toBoss = {toBoss2, toBoss2}
    local bossPosition = pos
